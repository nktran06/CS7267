...
def main():
    cols = ["bathroom", "bedroom", "days_on_zillow", "last_sold_price", "latitude", "living_area", "longitude", "lot_size", "year_built", "zestimate"]
    Portland_housing = pd.read_csv(r'C:\Users\Matthew Zinkil\Documents\portland_housing_clean.csv', header=None, names=cols, skiprows=1)
    ...
    X = Portland_housing[["bathroom", "bedroom", "days_on_zillow", "last_sold_price",  "living_area",  "lot_size", "year_built"]]
    Y = Portland_housing["zestimate"]
